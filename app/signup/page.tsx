...
import { Zap, Mail, Lock, ArrowRight, CheckCircle, ShieldCheck, Sparkles, Globe, Eye, EyeOff, ChevronLeft } from "lucide-react";
...
export default function Signup() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // API response ke nextStep ke basis pe redirection logic
            ...
            <div className="grid gap-2">
              ...
              <div className="relative group">
                ...
                <Input 
                  ...
                  className="pl-10 pr-10 h-11 bg-muted/20 focus:bg-background border-border/60 transition-all text-foreground" required 
