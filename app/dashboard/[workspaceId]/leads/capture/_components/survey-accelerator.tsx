                    ...
                    <div className="space-y-3">
                      ...
                      {(q.type === 'radio' || q.type === 'dropdown' || q.type === 'multiselect') && (
                        <div className="grid grid-cols-1 gap-2 pl-4 border-l-2 border-primary/20 pt-1">
                          {q.options?.map((opt, optIdx) => (
                            <div key={optIdx} className="flex gap-2">
                              <Input
                                ...
                                className="h-8 bg-background text-[11px] font-medium rounded-lg"
                              />
                          ...
                          <Button variant="outline" size="sm" onClick={() => addOption(q.id)} className="h-7 text-[9px] uppercase font-black tracking-tighter border-dashed">
                            + Add Option
                          </Button>
                        </div>
                      )}
