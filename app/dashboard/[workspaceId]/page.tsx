    ...
    <div className="flex flex-col h-full">
        ...
        actions={
          <div className="flex items-center gap-2">
            <Button
              variant="outline"
              size="sm"
              className="gap-2 hidden sm:flex bg-transparent border-border/50 hover:border-primary/30"
            >
            ...
            <Button
              variant="outline"
              size="icon"
              className="h-9 w-9 bg-transparent border-border/50 hover:border-primary/30"
            >
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-6 space-y-6 gradient-mesh min-h-full">
          ...
          {/* AI Status Bar */}
          <div className="flex items-center justify-between p-4 rounded-2xl bg-gradient-to-r from-accent/10 via-primary/5 to-accent/10 border border-accent/20 ai-glow-subtle">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-accent/20 ai-pulse">
